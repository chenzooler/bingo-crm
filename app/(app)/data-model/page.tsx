...
export default function DataModelPage() {
  const [activeTab, setActiveTab] = React.useState<"overview" | "sections" | "stages" | "mapping">("overview");
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5">
      ...
      <div className="flex items-center gap-1 bg-bingo-gray-100 p-1 rounded-2xl w-fit sticky top-2 z-10 bingo-shadow-sm">
        ...
        <TabBtn active={activeTab === "mapping"} onClick={() => setActiveTab("mapping")} icon={<GitBranch className="size-3.5" />} label="מיפוי 114 → 10" />
      </div>
